let urlParams;
let inquire_board_num;

$(document).ready(function () {
urlParams = getUrlParams();
inquire_board_num = urlParams.num;

$(".reFresh5").html("");
var div = "";

div += "<div class='col-md-11 mb-4'>";
//글 번호를 input type="hidden" 태그의 value값에 넣어서 보내기
div += "<input type='hidden' class='form-control' id='inquirenum' name='inquirenum' value='"+inquire_board_num+"'>";
div += "</div>";
...
function BoardCheckInput() {
    ...
    $.ajax({
      url: "./controller/putinquire_board.php", // 클라이언트가 HTTP 요청을 보낼 서버의 URL 주소
      ...
      success: function (response) {
        console.log(response);
          ...
          alert("답변 성공! 게시판 리스트 페이지로 이동합니다.");
