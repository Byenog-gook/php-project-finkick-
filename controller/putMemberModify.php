 ...
 * 입력받은 값을 db의 signup 테이블에 UPDATE하는 기능을 가지며,
 * 에러 결과를 json형식으로 반환함
 */
...
// putMemberModify.php는 signup 테이블에 가입정보를 수정(업데이트)하는 기능을 담당
...
// UPDATE member SET pass = '$password', nickname = '$nickname', email = '$email' WHERE id = '$id'
